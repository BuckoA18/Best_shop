...
Calculator.prototype.Update = function() {
    ...
    this.form.addEventListener("click", (event)=>{
        if (event.target === this.selectInput) this.packageInput.classList.toggle("open");
    });
...
Calculator.prototype.totalSum = function() {
    ...
    if (this.accountingChecked === true) this.result += this.prices.accountting;
    if (this.terminalChecked === true) this.result += this.prices.terminal;
    if (this.selectedOption === "professional") this.result += this.prices.packages.professional;
    if (this.selectedOption === "premium") this.result += this.prices.packages.premium;
};
document.addEventListener("DOMContentLoaded", function() {
    new Calculator();
});

//# sourceMappingURL=best_shop.7c0ccee6.js.map
